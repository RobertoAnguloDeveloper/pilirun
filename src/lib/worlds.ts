...
export const CHARACTERS: Character[] = [
  {
    ...
    stats: { level: 1, strength: 10, speed: 10, maxEnergy: 100, auraLevel: 1 },
    frames: {
      run: [
  ...
  },
  {
    ...
    color: '#60a5fa',
    scale: 0.95,
    image: '/assets/copito-avatar.webp',
    stats: { level: 1, strength: 8, speed: 11, maxEnergy: 110, auraLevel: 1 },
    frames: {
      run: [
        '/assets/copito-run-0.webp',
        '/assets/copito-run-1.webp',
        '/assets/copito-run-2.webp',
        '/assets/copito-run-3.webp',
        '/assets/copito-run-4.webp',
        '/assets/copito-run-5.webp',
      ],
      jump: ['/assets/copito-jump-0.webp', '/assets/copito-jump-1.webp'],
      slide: ['/assets/copito-slide-0.webp', '/assets/copito-slide-1.webp'],
      idle: ['/assets/copito-idle-0.webp'],
    },
  },
  {
    id: 'mimi',
    ...
    color: '#f472b6',
    scale: 0.95,
    image: '/assets/mimi-avatar.webp',
    stats: { level: 1, strength: 9, speed: 12, maxEnergy: 95, auraLevel: 1 },
    frames: {
      run: [
        '/assets/mimi-run-0.webp',
        '/assets/mimi-run-1.webp',
        '/assets/mimi-run-2.webp',
        '/assets/mimi-run-3.webp',
        '/assets/mimi-run-4.webp',
        '/assets/mimi-run-5.webp',
      ],
      jump: ['/assets/mimi-jump-0.webp', '/assets/mimi-jump-1.webp'],
      slide: ['/assets/mimi-slide-0.webp', '/assets/mimi-slide-1.webp'],
      idle: ['/assets/mimi-idle-0.webp'],
    },
  },
  {
    id: 'posho',
    ...
    color: '#facc15',
    scale: 0.9,
    image: '/assets/posho-avatar.webp',
    stats: { level: 1, strength: 7, speed: 10, maxEnergy: 120, auraLevel: 1 },
    frames: {
      run: [
        '/assets/posho-run-0.webp',
        '/assets/posho-run-1.webp',
        '/assets/posho-run-2.webp',
        '/assets/posho-run-3.webp',
        '/assets/posho-run-4.webp',
        '/assets/posho-run-5.webp',
      ],
      jump: ['/assets/posho-jump-0.webp', '/assets/posho-jump-1.webp'],
      slide: ['/assets/posho-slide-0.webp', '/assets/posho-slide-1.webp'],
      idle: ['/assets/posho-idle-0.webp'],
    },
  },
  {
    id: 'kuro',
    ...
    color: '#8b5cf6',
    scale: 0.95,
    image: '/assets/kuro-avatar.webp',
    stats: { level: 1, strength: 12, speed: 11, maxEnergy: 105, auraLevel: 2 },
    frames: {
      run: [
        '/assets/kuro-run-0.webp',
        '/assets/kuro-run-1.webp',
        '/assets/kuro-run-2.webp',
        '/assets/kuro-run-3.webp',
        '/assets/kuro-run-4.webp',
        '/assets/kuro-run-5.webp',
      ],
      jump: ['/assets/kuro-jump-0.webp', '/assets/kuro-jump-1.webp'],
      slide: ['/assets/kuro-slide-0.webp', '/assets/kuro-slide-1.webp'],
      idle: ['/assets/kuro-idle-0.webp'],
    },
  },
];
